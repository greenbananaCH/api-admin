...
### Checkout the project:
    ...
    git clone https://github.com/greenbananaCH/api-admin.git
...
### Clone, install and run in a oneliner
    ...
    git clone https://github.com/greenbananaCH/api-admin.git && cd api-admin && npm install && npm start & grunt serve
